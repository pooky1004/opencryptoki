...
#define NCMP_CKR_PIN_INCORRECT         0x000000A0UL
#define NCMP_CKR_PIN_LEN_RANGE         0x000000A2UL
#define NCMP_CKR_USER_ALREADY_LOGGED_IN 0x00000100UL
#define NCMP_CKR_USER_NOT_LOGGED_IN    0x00000101UL
#define NCMP_CKR_USER_TYPE_INVALID     0x00000103UL
