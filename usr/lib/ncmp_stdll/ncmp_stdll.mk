nobase_lib_LTLIBRARIES += opencryptoki/stdll/libpkcs11_ncmp.la

noinst_HEADERS += usr/lib/ncmp_stdll/tok_struct.h

opencryptoki_stdll_libpkcs11_ncmp_la_CFLAGS =				\
	-DDEV -D_THREAD_SAFE -DSHALLOW=0 -DNCMPTOK=1 -DLITE=0		\
	-DNOMD2 -DNODSA -DNORIPE -fPIC -I${srcdir}/usr/lib/ncmp_stdll	\
	-DTOK_NEW_DATA_STORE=0x0003000c					\
	-I${srcdir}/usr/lib/common -I${srcdir}/usr/include		\
	-DSTDLL_NAME=\"ncmptok\" -I${top_builddir}/usr/lib/api		\
	-I${srcdir}/usr/lib/api						\
	-I${srcdir}/ncmp/include

if AIX
opencryptoki_stdll_libpkcs11_ncmp_la_LDFLAGS = -qmkshrobj -lc \
	-lpthread -lcrypto -lrt -Wl,-bnoautoexp -Wl,-bstatic,-llber,-bdynamic \
	-export-symbols ${srcdir}/opencryptoki_tok.map.sym
else
opencryptoki_stdll_libpkcs11_ncmp_la_LDFLAGS =				\
	-shared -Wl,-z,defs,-Bsymbolic -lc -lpthread -lcrypto -lrt	\
	-llber -Wl,--version-script=${srcdir}/opencryptoki_tok.map
endif

opencryptoki_stdll_libpkcs11_ncmp_la_SOURCES =				\
	...
	usr/lib/ncmp_stdll/ncmp_specific.c usr/lib/common/attributes.c	\
